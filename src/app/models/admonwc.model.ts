...
export class AdmonWC {
    ...
    get imagenUrl() {
        ...
        if( !this.img ) {
            return `${ base_url }/files/uploads/obtener/administrativos/No_Image_Available`;
        } else if( this.img ) {
            return `${ base_url }/files/uploads/obtener/administrativos/${ this.img }`;
        } else { 
            return `${ base_url }/files/uploads/obtener/administrativos/No_Image_Available`;
        }
